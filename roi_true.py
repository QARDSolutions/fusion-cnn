...
if __name__ == '__main__':
  ...
  dest_path = './ACDC_DataSet/processed_acdc_dataset_cnn2'
  group_path = './ACDC_DataSet/processed_acdc_dataset_cnn2/Patient_Groups'

  # Training dataset
  train_dataset = './ACDC_DataSet/processed_acdc_dataset_cnn2/dataset/train_set_cnn2'
  validation_dataset = './ACDC_DataSet/processed_acdc_dataset_cnn2/dataset/validation_set_cnn2'
  test_dataset = './ACDC_DataSet/processed_acdc_dataset_cnn2/dataset/test_set_cnn2'
  out_path_train = './ACDC_DataSet/processed_acdc_dataset_cnn2/pickled/full_data_cnn2'
  hdf5_out_path = './ACDC_DataSet/processed_acdc_dataset_cnn2/hdf5_files_cnn2'
  #Final Test dataset
  final_testing_dataset = './ACDC_DataSet/testing'
  out_path_test = './ACDC_DataSet/processed_acdc_dataset_cnn2/pickled/final_test_cnn2'
