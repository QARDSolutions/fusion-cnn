...
path = 'hdf5_files_CNN1/train_set'
k = os.listdir(path)
a = []
b = []
...
for p in os.listdir(path):
     if p=='desktop.ini':
        ...
        labels_CNN1.append(classes[class_])

# validation set
    
path = 'hdf5_files_CNN1/validation_set'
k = os.listdir(path)
a = []
b = []
...
for p in os.listdir(path):
    if p=='desktop.ini':
        ...
        id_ = p.split('_')[1]
        class_ = label_dict[id_]
        labels_CNN1_val.append(classes[class_])
# test set
    
path = 'hdf5_files_CNN1/test_set'
k = os.listdir(path)
a = []
b = []
...
for p in os.listdir(path):
    if p=='desktop.ini':
        ...
        id_ = p.split('_')[1]
        class_ = label_dict[id_]
        labels_CNN1_test.append(classes[class_])