...
class Dataset(object):
    ...
    def read_patient_data(self, mode='train', roi_detect=False):
        """
...
if __name__ == '__main__':
  ...
  dest_path = './ACDC_DataSet/processed_acdc_dataset_cnn1'
  group_path = './ACDC_DataSet/processed_acdc_dataset_cnn1/Patient_Groups'

  # Training dataset
  train_dataset = './ACDC_DataSet/processed_acdc_dataset_cnn1/dataset/train_set_cnn1'
  validation_dataset = './ACDC_DataSet/processed_acdc_dataset_cnn1/dataset/validation_set_cnn1'
  test_dataset = './ACDC_DataSet/processed_acdc_dataset_cnn1/dataset/test_set_cnn1'
  out_path_train = './ACDC_DataSet/processed_acdc_dataset_cnn1/pickled/full_data_cnn1'
  hdf5_out_path = './ACDC_DataSet/processed_acdc_dataset_cnn1/hdf5_files_cnn1'
  #Final Test dataset
  final_testing_dataset = './ACDC_DataSet/testing'
  out_path_test = './ACDC_DataSet/processed_acdc_dataset_cnn1/pickled/final_test_cnn1'
  ...
  train_dataset = convert_nii_np(train_dataset, mode='train', roi_detect=False)
  save_data(train_dataset, 'train_set.pkl', out_path_train)
  print("---Processing Training dataset %s seconds ---" % (time.time() - start_time))
  validation_dataset = convert_nii_np(validation_dataset, mode='train', roi_detect=False)
  save_data(validation_dataset, 'validation_set.pkl', out_path_train)
  print("---Processing Training dataset %s seconds ---" % (time.time() - start_time))
  test_dataset = convert_nii_np(test_dataset, mode='train', roi_detect=False)
  save_data(test_dataset, 'test_set.pkl', out_path_train)
  print("---Processing Training dataset %s seconds ---" % (time.time() - start_time))

  print ('ROI->ED->ES test dataset')
  final_test_dataset = convert_nii_np(final_testing_dataset, mode='test', roi_detect=False)
